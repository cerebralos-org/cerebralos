// src/consolidate.js — Consolidation utilities (v3, from Connector/Write redesign)
// Provides: absolutizeDates, detectDuplicates, consolidate
// NOTE: sleep.js does NOT call consolidate() — the intelligence layer (claude -p
// headless via nightly-dream.md) handles dream consolidation.
// This module is available for standalone runs or future integration
// (e.g., deduplication of peripheral files written via write_memory).
import fs from 'fs';
...
// Relative date patterns → absolute date conversion (en + ja)
