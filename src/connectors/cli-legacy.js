// src/connectors/cli-legacy.js — CLI legacy connector (Connector Layer v3)
// Auto-detects `llm` or `claude` CLI tools.
// NOTE: sleep.js does NOT import this. The intelligence layer uses `claude -p`
// headless via execFile with stdin prompt directly (see sleep.js runIntelligence).
// This connector is available for future use by other modules.
